  ...
  <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2">
        <label htmlFor="company" className="block text-sm/6 font-semibold text-gray-900">Empresa</label>
        <div className="mt-2.5">
      ...
      <div className="sm:col-span-2">
        <label htmlFor="phone-number" className="block text-sm/6 font-semibold text-gray-900">Teléfono</label>
        <div className="mt-2.5">
      ...
      <div className="sm:col-span-2">
        <label htmlFor="message" className="block text-sm/6 font-semibold text-gray-900">Mensaje</label>
        <div className="mt-2.5">
      ...
      <div className="flex gap-x-4 sm:col-span-2">
        ...
        <label className="text-sm/6 text-gray-600" id="switch-1-label">
          <a href="#" className="font-semibold text-green-600">privacidad&nbsp;politica</a>.
        </label>
      </div>
    </div>
    <div className="mt-10">
