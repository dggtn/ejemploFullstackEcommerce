    ...
    return (
        <nav className='flex justify-between items-center  z-10 top-0 w-full py-5 px-8 text-sm font-light relative isolate overflow-hidden bg-green-900 sm:py-24 lg:py-20'>
            <ul className='flex items-center gap-3'>
                ...
                <li>
                    <svg className="size-6 shrink-0 text-white-400 group-hover:text-white-500" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                    </svg>
                    <span className="ml-2 text-sm font-medium text-white-700 group-hover:text-white-800">0</span>
                    <span className="sr-only">items en carrito,ver carrito</span>
                </li>
